...
public class ChessMatch {
    ...
    private boolean check;//Começa com falso;
    ...
    public boolean[][] posibleMoves(ChessPosition sourcePosition){//Imprimir as posiveis movimentos;
	...
	rook.increaseMoveCount();
         ...
         if(p instanceof Pawn){
             if(source.getColumn() != target.getColumn() && capturedPiece == null){
                 ...
                 if(p.getColor() == Color.WHITE){//Branco
    ...
    private boolean testCheck(Color color){
        ...
        for(Piece p : opponentPieces){                                                            //ou só !=color
    ...
    private void placeNewPiece(char column, int row, ChessPiece piece){
        board.placePiece(piece, new ChessPosition(column,row).toPositon());//poderia utilizar uma variavel auxiliar
